...
class RealPopulation extends Component {
    state = {
        isAdd: false,
        detail: {},
        showModal: false,
        ...
        tableData: [
            {
                ...
                year: "2018年",
                houseNumber: "2310",
                times: "2018-09-02 08:00:02",
                person: "王一凡",
            },{
                key:4,
                year: "2018年",
                houseNumber: "3123",
                times: "2018-05-12 16:41:02",
                person: "莫桦谊",
            }
        ]
    };
        ...
        return (
            <div style={{ padding: 20 }}>
                ...
                <Modal
                    ...
                    destroyOnClose={true}
                    title={this.state.isAdd ? "实有人数新增" : "实有人数"}
...
export default Form.create()(RealPopulation);
