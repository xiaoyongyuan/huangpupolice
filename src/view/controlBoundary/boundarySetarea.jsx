...
import AlarmFiltering from "./AlarmFiltering";
const blue = "#5063ee";
const red = "#ED2F2F";
const { TabPane } = Tabs;
      ...
      <div className="boundary1">
        <div className="Setarea">
          <Tabs defaultActiveKey="1">
            ...
            <TabPane tab="误报过滤" key="2">
              <AlarmFiltering cid={this.state.cid} eid={this.state.eid} />
            </TabPane>
          </Tabs>
          <Modal
            title="提示信息"
