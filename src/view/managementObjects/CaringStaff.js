...
import Image1 from "../../assets/image/car2.jpg";
import Image2 from "../../assets/image/car5.jpg";
import Image3 from "../../assets/image/car3.jpg";
import Image4 from "../../assets/image/car4.jpg";
import zh_CN from "antd/lib/locale-provider/zh_CN";
import './public.less'
import PersonSearchForm3 from './personSearchForm3'
import moment from 'moment'
const { Option } = Select;
class CaringStaff extends Component {
    ...
    renderRecord = (record) => {
        return (<div className='infoWrap'>
            ...
            <div style={{ width: '90%' }}>
                ...
                <div className='infoDetail'>
                    <div style={{ marginRight: 30 }}>车牌号：{record.idNum}</div>
                    <div style={{ marginRight: 30 }}>使用性质：{record.sex}</div>
                    <div style={{ marginRight: 30 }}>品牌型号：{record.birthday}</div>
                    <div style={{ marginRight: 30 }}>车辆类型：{record.height}</div>
                    <div style={{ marginRight: 30 }}>注册日期：{record.pushCenter}</div>
                    <div style={{ marginRight: 30 }}>发放时间：{record.pushApp}</div>
                </div>
                <div className='infoDetail'>
                    <div style={{ marginRight: 30 }}>车辆识别代号：{record.address}</div>
                    <div style={{ marginRight: 30 }}>发动机号：{record.creaton}</div>
                </div>
...
export default Form.create()(CaringStaff);